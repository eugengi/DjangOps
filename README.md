...
[![Inline docs](https://inch-ci.org/github/dwyl/hapi-auth-jwt2.svg?branch=master)](https://github.com/eugengi/DjangOps/blob/main/README.md) [![build](https://github.com/eugengi/DjangOps/actions/workflows/build.yaml/badge.svg)](https://github.com/eugengi/DjangOps/actions/workflows/build.yaml) [![Python QA - Tests](https://github.com/eugengi/DjangOps/actions/workflows/test.yaml/badge.svg)](https://github.com/eugengi/DjangOps/actions/workflows/test.yaml) [![Python QA - Lint](https://github.com/eugengi/DjangOps/actions/workflows/lint.yaml/badge.svg)](https://github.com/eugengi/DjangOps/actions/workflows/lint.yaml) [![Python version](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12-blue?style=flat&logo=python&logoColor=yellow)](https://github.com/eugengi/DjangOps/blob/main/tox.ini#L5) [![docker](https://img.shields.io/badge/docker-enabled-blue?style=flat&logo=docker&labelColor=white)](https://www.docker.com/products/docker-desktop/) [![Known Vulnerabilities](https://snyk.io/test/github/eugengi/DjangOps/main/badge.svg)](https://snyk.io/test/github/eugengi/DjangOps) [![pre-commit.ci status](https://results.pre-commit.ci/badge/github/eugengi/DjangOps/main.svg)](https://results.pre-commit.ci/latest/github/eugengi/DjangOps/main) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-blue.svg)](http://makeapullrequest.com) [![Activity](https://img.shields.io/badge/status-active-brightgreen)](https://github.com/eugengi/DjangOps/commits/main) [![Versioning](https://img.shields.io/badge/versioning-semver-black?logo=semver)](https://semver.org/) [![pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit)](https://github.com/pre-commit/pre-commit) [![Package Manager: uv](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/uv/main/assets/badge/v0.json)](https://github.com/astral-sh/uv) [![Linter: Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff) [![Style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)
...
or [Linux].  
I'd recommend Microsoft's documentation to set up [Docker on WSL2] if you're
on Windows.
...
git clone git@github.com:eugengi/DjangOps.git my-project
cd my-project
```
